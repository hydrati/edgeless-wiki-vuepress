...
![](https://gitee.com/cnotech/edgeless-wiki-vuepress/raw/master/docs/images/2_1581665552242.png)

2. 启动虚拟机
2. 将微信安装程序拖放至虚拟机
3. 运行桌面`Cameyo单文件打包制作v3.1.1530.0汉化增强绿色版`文件夹内的`扫描安装过程并打包.exe`

![](https://gitee.com/cnotech/edgeless-wiki-vuepress/raw/master/docs/images/7_1581665615913.png)

5. 等待扫描结束
2. 扫描结束后会出现如下窗口

![](https://gitee.com/cnotech/edgeless-wiki-vuepress/raw/master/docs/images/9_1581665635431.png)

7. 此时运行微信安装程序
2.  按照正常方式安装

![](https://gitee.com/cnotech/edgeless-wiki-vuepress/raw/master/docs/images/11.png)

9.  点击安装已完成并再次耐心等待扫描结束
2. 建立一个Edgeless插件工作目录（如果不知道这个是什么，请先阅读父章节[开发插件包](plugin.md)）

![](https://gitee.com/cnotech/edgeless-wiki-vuepress/raw/master/docs/images/14.png)
...
![](https://gitee.com/cnotech/edgeless-wiki-vuepress/raw/master/docs/images/15.png)
...
![](https://gitee.com/cnotech/edgeless-wiki-vuepress/raw/master/docs/images/12.png)

15. 使用包编辑器打开文档文件夹内的打包exe

![](https://gitee.com/cnotech/edgeless-wiki-vuepress/raw/master/docs/images/13.png)

16. 可以看到如图所示页面

![](https://gitee.com/cnotech/edgeless-wiki-vuepress/raw/master/docs/images/16.png)

17. 打开注册表选项卡，并点击如图所示按钮导出注册表至工程目录内的`reg.reg`；使用`RegWorkshop`软件适当清理注册表中与程序安装无关的内容（包括用户使用痕迹）

![](https://gitee.com/cnotech/edgeless-wiki-vuepress/raw/master/docs/images/17.png)

18. 打开文件选项卡，并点击如图所示按钮保存除`Icons`和`Logs`以外文件到工程目录内

![](https://gitee.com/cnotech/edgeless-wiki-vuepress/raw/master/docs/images/18.png)
此时目录内应当有以下内容
...
![](https://gitee.com/cnotech/edgeless-wiki-vuepress/raw/master/docs/images/19.png)

20. 点击如图所示按钮进行筛选

![](https://gitee.com/cnotech/edgeless-wiki-vuepress/raw/master/docs/images/20.png)

21. 筛选条件如图↓

![](https://gitee.com/cnotech/edgeless-wiki-vuepress/raw/master/docs/images/21.png)

22. 对事件逐个按下`Ctrl+K`按键并检查调用的函数库

![](https://gitee.com/cnotech/edgeless-wiki-vuepress/raw/master/docs/images/22.png)
...
![](https://gitee.com/cnotech/edgeless-wiki-vuepress/raw/master/docs/images/23.png)
...
![](https://gitee.com/cnotech/edgeless-wiki-vuepress/raw/master/docs/images/24.png)
